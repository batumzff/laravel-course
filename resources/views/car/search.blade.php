<x-app-layout>
    ...
    <section>
      <div class="container">
        <div class="items-center justify-between sm:flex mb-medium">
          <div class="flex items-center">
            <button class="flex items-center show-filters-button">
        ...
        <div class="search-car-results-wrapper">
          <div class="search-cars-sidebar">
            ...
            <section class="find-a-car">
              <form action="/s.html" method="GET" class="flex find-a-car-form card p-medium">
          ...
          <div class="search-cars-results">
            <div class="car-items-listing">
              <div class="car-item card">
                <a href="#">
                  <img src="/img/cars/Lexus-RX200t-2016/1.jpeg" alt="" class="rounded-t car-item-img" />
                </a>
                <div class="p-medium">
